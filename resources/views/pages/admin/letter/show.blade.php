            ...
            <div class="row gx-4">
                ...
                <div class="col-lg-5">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                @if (explode('.', explode('/',$item->letter_file)[(count(explode('/',$item->letter_file)) - 1)])[1] == 'pdf')
                                    <embed src="{{ Storage::url($item->letter_file) }}" width="500" height="375" type="application/pdf">
                                @else
                                <p style="padding: 3rem 1rem;text-align: center;font-style: italic;">format file tidak didukung</p>
                                @endif
                            </div>
                        </div>
                    </div>
