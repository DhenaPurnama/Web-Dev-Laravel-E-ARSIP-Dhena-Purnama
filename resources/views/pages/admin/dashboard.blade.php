                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-6 col-xxl-12">
                                    <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                        ...
                                        <p class="text-gray-700 mb-0">Di Website E-Arsip Surat</p>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-xxl-12 text-center"><img class="img-fluid" src="{{ asset('admin/assets/img/Winni Code.png') }}" style="max-width: 26rem" /></div>
                            </div>
                        </div>
                    </div>
                </div>
